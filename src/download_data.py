"""Download subliminal learning number datasets from HuggingFace.

Saves each dataset as JSONL with chat-template messages format.

Usage:
    uv run python -m src.download_data
    uv run python -m src.download_data --conditions eagle lion
"""
...
from src.config import DATA_DIR, DATASET_CONDITIONS, HF_DATASETS
